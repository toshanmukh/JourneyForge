...
command_fresh_clone="ls -ltr && \
 git clone https://${gituser}:${gittoken}@gitlab.stackroute.in/stackroute-pgp-wave6/journeyforge/journeyforge_application.git -b ${branch} && \
 cd /home/ubuntu/journeyforge_application && \
